...
class DatabaseConnectionUtils:
    ...
    def parse_connection_string(cls, connection_string: str) -> Dict[str, str]:
        ...
        try:
            ...
            # Extract components
            engine = parsed.scheme.split('+')[0].lower()  # Handle postgresql+psycopg2, mysql+pymysql
            ...
            return {
                ...
                'needs_creation': engine in ['postgresql', 'mysql']  # SQLite auto-creates
            }
    ...
    @classmethod
    def build_connection_string(cls, components: Dict[str, str], target_database: str) -> str:
        """
    ...
    def validate_database_name(cls, database_name: str) -> bool:
        ...
        if any(char in database_name.lower() for char in [';', "'", '"', '\\', '/', '*', '?', '<', '>', '|']):
            return False
    ...
    @classmethod
    def generate_database_name(cls, base_name: str = "memori", suffix: str = None, prefix: str = None) -> str:
        """
