...
class ChatHistory(Base):
    ...
    # Relationships
    short_term_memories = relationship("ShortTermMemory", back_populates="chat", cascade="all, delete-orphan")
...
class ShortTermMemory(Base):
    ...
    chat_id = Column(String(255), ForeignKey('chat_history.chat_id', ondelete='SET NULL'))
    ...
    __table_args__ = (
        ...
        Index('idx_short_term_namespace_category', 'namespace', 'category_primary', 'importance_score'),
    )
...
class LongTermMemory(Base):
    ...
    __table_args__ = (
        ...
        Index('idx_long_term_scores', 'novelty_score', 'relevance_score', 'actionability_score'),
        ...
        Index('idx_long_term_conscious_flags', 'is_user_context', 'is_preference', 'is_skill_knowledge', 'promotion_eligible'),
        ...
        Index('idx_long_term_namespace_category', 'namespace', 'category_primary', 'importance_score'),
    )
