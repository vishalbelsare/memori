    ...
    def enable(self) -> bool:
        ...
        with self._lock:
            ...
            try:
                ...
                anthropic.Anthropic = self._create_wrapped_anthropic_client(anthropic._memori_original_Anthropic)
                anthropic.AsyncAnthropic = self._create_wrapped_async_anthropic_client(anthropic._memori_original_AsyncAnthropic)
