...
try:
    ...
    HAS_MODIFYING_ROUTER = hasattr(litellm, 'Router') and hasattr(litellm.Router, 'pre_call_hook')
    ...
    def _litellm_success_callback(self, kwargs, response, start_time, end_time):
        ...
        try:
            ...
            if user_input and ai_output:
                ...
                logger.debug(f"LiteLLM callback: Recorded conversation for model {model}")
