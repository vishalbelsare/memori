...
class TestDatabaseIntegration:
    ...
    def test_database_persistence(self, persistent_memory_manager, sample_processed_memory, temp_db_file):
        ...
        found_memory = next((m for m in memories if m.get("memory_id") == memory_id), None)
    ...
    def test_large_data_storage(self, persistent_memory_manager):
        ...
        for i in range(50):
            memory = ProcessedMemory(
                ...
                importance=MemoryImportance(
                    ...
                    retention_type=RetentionType.long_term if i % 3 == 0 else RetentionType.short_term,
        ...
        # Test statistics
        stats = persistent_memory_manager.get_memory_statistics(namespace="large_data_test")
    ...
    def test_backup_restore_integration(self, persistent_db_manager, temp_db_file):
        ...
        try:
            ...
            found_memory = next(
                (m for m in backup_memories if m.get("memory_id") == memory_id), 
                None
            )
            assert found_memory is not None
    ...
    def test_transaction_rollback_integration(self, persistent_db_manager):
        ...
        initial_stats = memory_manager.get_memory_statistics(namespace="transaction_test")
