    ...
    try:
        ...
        with db_manager.SessionLocal() as session:
            ...
            result = session.execute(
                text("SELECT to_tsvector('english', 'PostgreSQL full-text search with tsvector')")
            ).fetchone()
        ...
        try:
            with db_manager.SessionLocal() as session:
                ...
                if result:
                    ...
                    print("   ⚠️  No search vector indexes found (may need schema initialization)")
