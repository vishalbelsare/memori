...
def create_test_database():
    ...
    try:
        ...
        cursor.execute("ALTER DATABASE memori_test CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci")
...
def main():
    ...
    try:
        ...
        db_manager = SQLAlchemyDatabaseManager("mysql+mysqlconnector://root:@127.0.0.1:3306/memori_test")
