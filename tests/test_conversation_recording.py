...
def test_openai_recording_formats():
    ...
    ), f"Expected 'Hello, how are you?', got '{user_input}'"
    ...
    assert (
        "Called get_weather" in ai_output
    ), f"Function call not detected in: {ai_output}"
...
def test_anthropic_recording_formats():
    ...
    ), f"Expected 'Hello Claude!', got '{user_input}'"
    print("✓ Basic text extraction")
...
def test_error_handling():
    ...
    assert (
        user_input == ""
    ), f"Expected empty string for missing content, got '{user_input}'"
    ...
    assert (
        "Error extracting" in ai_output or ai_output == ""
    ), f"Expected error message or empty, got '{ai_output}'"
    ...
    assert (
        user_input == ""
    ), f"Expected empty string for no messages, got '{user_input}'"
    ...
    assert (
        ai_output == "" or "Error extracting" in ai_output
    ), f"Expected error or empty, got '{ai_output}'"
