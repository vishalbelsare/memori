...
def install_litellm_hooks():
    ...
    try:
        ...
        _original_litellm_functions['acompletion'] = getattr(litellm, 'acompletion', None)
...
def uninstall_litellm_hooks():
    ...
    try:
        ...
        if 'acompletion' in _original_litellm_functions and _original_litellm_functions['acompletion']:
