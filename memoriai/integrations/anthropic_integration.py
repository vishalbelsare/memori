...
def install_anthropic_hooks():
    ...
    try:
        ...
        _original_anthropic_functions['messages_create'] = anthropic.resources.messages.Messages.create
...
def uninstall_anthropic_hooks():
    ...
    try:
        ...
        if 'messages_create' in _original_anthropic_functions:
            anthropic.resources.messages.Messages.create = _original_anthropic_functions['messages_create']
