...
class ConfigManager:
    ...
    def validate_configuration(self) -> bool:
        ...
        try:
            ...
            if self._settings.agents.conscious_ingest and not self._settings.agents.openai_api_key:
    ...
    def get_config_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "is_production": self._settings.is_production() if self._settings else False,
        }
