...
def example_basic_usage():
    ...
    print("📝 Ready for API calls - conversations will be auto-recorded")
...
def example_azure_openai():
    ...
    print("🔷 Configured for Azure OpenAI endpoint")
...
def example_provider_config():
    ...
    print("✅ Created client with advanced configuration")
...
async def example_async_usage():
    ...
    print("🔄 Ready for async API calls")
...
def example_direct_import():
    ...
    client1 = MemoriOpenAIInterceptor(
        memori, api_key=os.getenv("OPENAI_API_KEY", "your-api-key-here")
    )
...
def example_streaming_support():
    ...
    create_streaming_handler(memori)

    print("✅ Created client with streaming support")
    print("🌊 Stream handler available for advanced use cases")
...
def example_memory_features():
    ...
    print("✅ Created client with memory features enabled")
    print("🧠 Context injection: Conscious Ingest")
...
def example_legacy_compatibility():
    ...
    print("⚠️ Migration path: Replace MemoriOpenAI with create_openai_client()")
