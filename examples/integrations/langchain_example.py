...
def main():
    ...
    try:
        ...
        # Create messages
        messages = [
            SystemMessage(content="You are a helpful AI assistant specializing in LangChain and AI development."),
            HumanMessage(content="What are the main components of LangChain and how do they work together?")
        ]
...
"""
        ...
        messages_with_context = [
            ...
            HumanMessage(content="How should I choose between different vector database solutions for my LangChain application?")
        ]
