...
ollama_provider = ProviderConfig.from_custom(
    ...
    model=os.getenv("OLLAMA_MODEL", "llama3.2:3b")  # Default to llama3.2:3b, can be overridden
)
...
print(f"Memori Ollama Example - Chat with {ollama_provider.model} while memory is being tracked")
...
while 1:
    try:
        ...
        print(f"And that you have pulled the model: 'ollama pull {ollama_provider.model}'")
        continue